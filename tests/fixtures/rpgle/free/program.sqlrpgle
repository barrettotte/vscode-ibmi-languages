       //
       // A whole program with embedded SQL, written in a column-limited
       // member: the statements are the ones the fully free-form fixture
       // carries, moved into columns 8-80.
       //
       // Member: SQLREGC   Compilable: complete program, but not built; its
