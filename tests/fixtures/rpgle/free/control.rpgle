       //
       // The free-form control statement in a column-limited member: the
       // statements are the ones the fully free-form fixture carries, moved
       // into columns 8-80 so the two can be compared. A keyword with a
       // documented closed set of values appears once per value.
       //
       // Member: CLCTL   Compilable: no (declarations only)
