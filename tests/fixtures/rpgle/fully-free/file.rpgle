**FREE
//
// The free-form file definition statement. The device keyword stands
// in for the device columns of a fixed-format file specification,
// USAGE for the file type and KEYED for the record address type.
//
// Member: FREEFILE   Compilable: no (declarations only)
