**FREE
//
// The free-form procedure. DCL-PROC opens a subprocedure and DCL-PI
// gives its interface; DCL-PR declares one the module only calls.
// Every procedure keyword appears here.
//
// Member: FREEPROC   Compilable: no (procedures only, no main)
